...
export default function ComputerAccessoriesSidebar() {
  const colors = [
  ...
  return (
    <aside className="space-y-6 w-full max-w-[280px]">
      ...
      <div className="bg-[#F8F9FA] p-5 space-y-8 rounded-sm border border-slate-100/50 shadow-sm">
        ...
        {/* 2. Isolated Categories Tree Module */}
        <section>
          ...
          <div className="space-y-3 text-[12px] font-medium">
            ...
            <div className="pl-1 space-y-3">
              ...
              {/* Level 2: Computer Accessories Sub-Branch */}
              <div className="pl-4 space-y-3 border-l border-slate-200/60 font-medium">
                ...
                {/* Level 3: Active Subcategory link layout exactly like image_28dbd9.png */}
                <div className="pl-4">
                  <Link href="/categories/computer-accessories" className="block text-[#149fcd] font-bold">
                    Laptop Bags & Sleeves
                  </Link>
                </div>
              </div>
        ...
        {/* 3. Price Slider Range Module (Matches ₦750,000.00 ceiling) */}
        <section>
          <h3 className="font-bold text-slate-800 text-sm mb-4 border-b border-slate-200 pb-2 uppercase tracking-wider text-[11px]">
            Price
          </h3>
