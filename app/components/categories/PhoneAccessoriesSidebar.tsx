...
export default function PhoneAccessoriesSidebar() {
  ...
  return (
    <aside className="space-y-6 w-full max-w-[280px]">
      ...
      <div className="bg-[#F8F9FA] p-5 space-y-8 rounded-sm border border-slate-100/50 shadow-sm">
        ...
        <section>
          ...
          <div className="space-y-3 text-[12px] font-medium">
            ...
            <div className="pl-1 space-y-3">
              {/* Level 1: Phones & Tablets Parent Branch */}
              ...
              {/* Level 2: Phone Accessories Active Sub-Branch */}
              <div className="pl-4 space-y-3 border-l border-slate-200/60 font-medium">
                ...
                {/* Level 3: Subcategories Expanded Array List */}
                <div className="pl-3 space-y-2.5 text-slate-400 font-normal text-[11px]">
                  {accessoriesSubcategories.map((sub, idx) => (
                    <Link 
                      key={idx} 
                      href={`/categories/phone-accessories?subcategory=${sub.toLowerCase().replace(/ & /g, '-').replace(/\s+/g, '-')}`}
        ...
        {/* 3. Brands Filtering Block Section */}
        <section>
          <h3 className="font-bold text-slate-800 text-sm mb-4 border-b border-slate-200 pb-2 uppercase tracking-wider text-[11px]">
            Brands
          </h3>
          <label className="flex items-center gap-3 cursor-pointer group">
            ...
            <span className="text-[12px] text-slate-500 group-hover:text-[#149fcd] transition-colors">Samsung</span>
          </label>
        </section>

        {/* 4. Price Slider Range Module (Updated to match ₦177,000.00 exact limit marker) */}
        <section>
          <h3 className="font-bold text-slate-800 text-sm mb-4 border-b border-slate-200 pb-2 uppercase tracking-wider text-[11px]">
            Price
          </h3>
