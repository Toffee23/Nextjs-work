...
// Your exact specifications and static asset routing endpoints
...
export default function ComputersGrid({ viewMode }: ComputersGridProps) {
  return (
    <div className="w-full">
      {viewMode === 'grid' ? (
        /* --- GRID MODE LAYOUT (3 Columns) --- */
