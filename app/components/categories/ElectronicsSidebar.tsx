...
export default function ElectronicsSidebar() {
  const colors = [
  ...
  return (
    <aside className="space-y-6 w-full max-w-[280px]">
      ...
      <div className="bg-[#F8F9FA] p-5 space-y-8 rounded-sm border border-slate-100/50 shadow-sm">
        ...
        <section>
          ...
          <div className="space-y-3 text-[12px] font-medium">
            ...
            <div className="pl-1 space-y-3">
              {/* Main Electronics Branch Header */}
              ...
              {/* Child Nodes Grouping matched precisely from image_1d859f.png */}
              <div className="pl-4 space-y-3.5 border-l border-slate-200/60 text-slate-500 font-medium">
                
                {/* Branch A: Camera & Photos */}
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-slate-500">
                    <span>Camera & Photos</span>
                    <Minus size={10} className="text-slate-300" />
                  </div>
                  <div className="pl-4 space-y-2 text-slate-400 font-normal text-[11px]">
                    <Link href="/categories/electronics?sub=photography" className="block hover:text-[#149fcd]">Photography</Link>
                    <Link href="/categories/electronics?sub=accessories" className="block hover:text-[#149fcd]">Accessories</Link>
                  </div>
                </div>

                {/* Branch B: Generators & Portable Power */}
                <Link href="/categories/electronics?sub=generators" className="block text-slate-500 hover:text-[#149fcd]">
                  Generators & Portable Power
                </Link>

                {/* Branch C: Home Audio */}
                <Link href="/categories/electronics?sub=home-audio" className="block text-slate-500 hover:text-[#149fcd]">
                  Home Audio
                </Link>

                {/* Branch D: Television & Video */}
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-slate-500">
                    <span>Television & Video</span>
                    <Minus size={10} className="text-slate-300" />
                  </div>
                  <div className="pl-4 space-y-2 text-slate-400 font-normal text-[11px]">
                    <Link href="/categories/electronics?sub=smart-tvs" className="block hover:text-[#149fcd]">Smart TVs</Link>
                    <Link href="/categories/electronics?sub=led-tvs" className="block hover:text-[#149fcd]">LED TVs</Link>
                  </div>
                </div>

                {/* Branch E: Electronic Accessories */}
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-slate-500">
                    <span>Electronic Accessories</span>
                    <Minus size={10} className="text-slate-300" />
                  </div>
                  <div className="pl-4 space-y-2.5 text-slate-400 font-normal text-[11px]">
                    <Link href="/categories/electronics?sub=surge-protectors" className="block hover:text-[#149fcd]">Surge Protectors</Link>
                    <Link href="/categories/electronics?sub=extension-boxes" className="block hover:text-[#149fcd]">Extension Boxes</Link>
                    <Link href="/categories/electronics?sub=power-banks" className="block hover:text-[#149fcd]">Power Banks</Link>
                    <Link href="/categories/electronics?sub=usb-cables" className="block hover:text-[#149fcd]">USB Cables</Link>
                  </div>
                </div>
        ...
        {/* 3. Price Slider Range Module (Updated bar marker to ₦110,000.00 ceiling) */}
        <section>
          <h3 className="font-bold text-slate-800 text-sm mb-4 border-b border-slate-200 pb-2 uppercase tracking-wider text-[11px]">
            Price
          </h3>
