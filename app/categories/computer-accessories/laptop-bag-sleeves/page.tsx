...
import { LayoutGrid, List, ChevronDown, Info } from "lucide-react";

// Component imports matching your architectural system
import ComputerAccessoriesSidebar from "@/app/components/categories/ComputerAccessoriesSidebar";
    ...
    <main className="bg-white min-h-screen font-sans">
      ...
      <div className="relative h-64 md:h-32 md:mb-12 w-full flex items-center overflow-hidden">
        <Image 
          ...
          alt="Desktop Category Header Background" 
          fill 
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full px-6 md:px-16">
          ...
          <p className="text-sm text-slate-500 mt-2 uppercase tracking-widest flex items-center gap-2 font-medium">
            Home <span className="text-slate-300">.</span> Products <span className="text-slate-300">.</span> Computers <span className="text-slate-300">.</span> <span className="text-sky-600">Laptop</span>
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 space-y-8">
            ...
            {/* --- JUMMALL EMPTY PRODUCT ALERT STATE BAR VIEW --- */}
            <div className="bg-[#FEFCE8] border border-yellow-200 rounded-sm p-4 flex items-center gap-3 text-yellow-800 text-xs font-medium shadow-sm animate-in fade-in duration-200">
