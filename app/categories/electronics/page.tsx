...
import ElectronicSidebar from "../../components/categories/ElectronicsSidebar";
import ElectronicsGrid from "../../components/categories/ElectronicsGrid";
    ...
    <main className="bg-white min-h-screen font-sans">
      ...
      <div className="relative h-64 md:h-32 md:mb-12 w-full flex items-center overflow-hidden">
        ...
        <Image 
          ...
          alt="Electronics Category Header Background" 
          fill 
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full px-6 md:px-16">
          ...
          <p className="text-sm text-slate-500 mt-2 uppercase tracking-widest flex items-center gap-2 font-medium">
            Home <span className="text-slate-300">.</span> Products <span className="text-slate-300">.</span> <span className="text-sky-600">Electronics</span>
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 space-y-8">
            ...
            <ElectronicsGrid viewMode={viewMode} />
