...
// Modularized Category Component Imports matching Phone Accessories path conventions
import PhoneAccessoriesSidebar from "../../components/categories/PhoneAccessoriesSidebar";
import PhoneAccessoriesGrid from "../../components/categories/PhoneAccessoriesGrid";

export default function PhoneAccessoriesCategoryPage() {
  const [viewMode, setViewMode] = useState<'grid' | 'list'>('grid');

  return (
    <main className="bg-white min-h-screen font-sans">
      
      {/* --- BREADCRUMB HEADER (Full Background Image matching snapshot) --- */}
      <div className="relative h-64 md:h-32 md:mb-12 w-full flex items-center overflow-hidden">
        <Image 
          src="/breadcrumb-1.jpg" 
          alt="Phone Accessories Category Header Background" 
          fill 
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full px-6 md:px-16">
          <h1 className="text-4xl font-black tracking-tight text-[#0F172A] font-montserrat">
            Phone Accessories
          </h1>
          <p className="text-xs text-slate-500 mt-2 uppercase tracking-widest flex items-center gap-2 font-medium">
            Home <span className="text-slate-300">.</span> Products <span className="text-slate-300">.</span> Phones & Tablets <span className="text-slate-300">.</span> <span className="text-sky-600">Phone Accessories</span>
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-slate-100 pb-4 gap-4 sm:gap-0">
              ...
              {/* Filtering Controls Options Dropdowns */}
            ...
            <PhoneAccessoriesGrid viewMode={viewMode} />
